...
def generate_launch_description():
    ...
    colorFramerate  = LaunchConfiguration('colorFramerate',  default=30)
    monoResolution  = LaunchConfiguration('monoResolution',  default = "480p")
    monoFramerate   = LaunchConfiguration('monoFramerate',   default=30)
    ...
    rgb_stereo_node = launch_ros.actions.Node(
            package='pilsbot_depthai', executable='h265_node',
            output='screen',
